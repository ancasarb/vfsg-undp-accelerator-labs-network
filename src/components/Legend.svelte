...
<g bind:this={group}>
	...
	>
	<text class="note" {x} y={initialY + padding * 4}>(descending order).</text>

	<rect x={x + 100} y={initialY + 110} width={20} height={70} fill="#02aad1" />
	<line x1={x + 110} y1={initialY + 170} x2={x + 110} y2={initialY + 210} stroke="black" />
    <text class="annotation" x={x + 107} y={initialY + 220}>n. projects</text>
    ...
    <text class="annotation" x={x + 190} y={initialY + 168}>n. projects</text>
    ...
    <text class="annotation" x={x + 35} y={initialY + 165}>n. projects</text>
